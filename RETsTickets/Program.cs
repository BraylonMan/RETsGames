...
builder.Services.AddDbContext<RETsGamesContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("RETsGamesContext") ?? throw new InvalidOperationException("Connection string 'RETsGamesContext' not found.")));
